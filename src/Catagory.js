...
import { insertCatagory } from "./API/comman_api";
...
export default function Catagory() {
  ...
  const updateCatagory = (e) => {
    setInputCatagory({ ...inputCatagory, [e.target.name]: e.target.value });
  };
  console.log(inputCatagory);

  const submitCatagory = async () => {
    if (inputCatagory.length == 0) {
      toast.error("please enter name", { position: "top-center" });
    } else {
      console.log("....");
      const response = await insertCatagory(inputCatagory);
            ...
            <>
              ...
              <div className="container-fluid" id="container-wrapper">
                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 className="h3 mb-0 text-gray-800"> Catagory Form</h1>
                  <ol className="breadcrumb">
                    <li className="breadcrumb-item">
                      <a href="./">Home</a>
                    </li>
                    <li className="breadcrumb-item">Catagory</li>
